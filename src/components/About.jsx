        ...
        <div className="flex flex-col items-center md:space-x-12">
          <div className="flex-1">
            <p className="text-lg mb-8 text-justify">
              I am currently pursuing a Master of Science in Computer Science at the University of Central Missouri 
              with a GPA of 3.5/4.0. I have over 3 years of full-time experience as a Software Engineer at Wipro and 
            ...
            <div className="flex justify-center items-center space-x-6 my-8">
              ...
              <a href="nuthalapatisnehavarsha11@gmail.com"
                className="transform transition-transform duration-300 hover:scale-105">
                <img src={MailImage} alt="Email" className="w-10 h-10" />
              </a>
              <a href="https://www.geeksforgeeks.org/user/snehavarshan/" target="_blank" rel="noopener noreferrer"
                className="transform transition-transform duration-300 hover:scale-105">
                <img src={GeeksforGeeksImage} alt="GeeksforGeeks" className="w-10 h-10" />
              </a>
              <a href="https://leetcode.com/u/nikhilmarri98/" target="_blank" rel="noopener noreferrer"
                className="transform transition-transform duration-300 hover:scale-105">
